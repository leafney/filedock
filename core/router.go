...
func registerRoutes(app *fiber.App, versionAPI *api.VersionAPI, sessionAPI *api.SessionAPI, roomAPI *api.RoomAPI, fileAPI *api.FileAPI, streamAPI *api.StreamAPI, limiter *service.RateLimiter, chatAPI *api.ChatAPI, notificationAPI *api.NotificationAPI) {
	...
	app.Get("/api/v1/rooms/:code/file-trash", fileAPI.HandleTrashList)
	...
	app.Post("/api/v1/rooms/:code/files/:fileId/trash", fileAPI.HandleTrash)
	app.Post("/api/v1/rooms/:code/files/:fileId/restore", fileAPI.HandleRestore)
	app.Delete("/api/v1/rooms/:code/files/:fileId/purge", fileAPI.HandlePurge)
	app.Post("/api/v1/rooms/:code/file-restore-requests/:requestId/approve", fileAPI.HandleApproveRestore)
