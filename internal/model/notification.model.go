...
type NotificationRecord struct {
	...
	FileRecipientID   string `gorm:"type:text;not null;uniqueIndex:idx_notification_records_occurrence"`
	DeliveryVersion   int64  `gorm:"not null;uniqueIndex:idx_notification_records_occurrence"`
